async function yangshi3(dates) { 
    ...
    const areaHRGenerator1 = d3.areaRadial()
        .angle(d => angleScale1(dateAccessorH(d)))
        .outerRadius(d=>radiusScaleHR(HRAccessor(d)))//d=>radiusScaleHR(HRbaseline/3))
        .innerRadius(d=>radiusScaleHR(HRAccessor(d))-HRVRadiusScalexuxian(HRVAccessor(d)))
        .curve(d3.curveNatural); 
