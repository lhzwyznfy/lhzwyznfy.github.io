async function drawChartchakan(dates) { 
  console.log(dates)
  // 1. Access data
    //tags 
  ...
  const tooltipheight ="460px";
  const tooltipwidth = "460px";
  tooltip.id="tooltip";
  ...
  tooltip.style.background="#EB5C6E";
  ...
  tooltip2    
    .style("transform", `translate(${
    width-dimensions.margin.right-dimensions.boundedRadius/1.6-230
    }px, ${
    dimensions.margin.top + dimensions.boundedRadius/1.8-230
    }px)`)
  //tooltip--------------------------------------------------------------------
  ...
  d3.select("#date-display")
    ...
    d3.selectAll('.round')
      .on('mouseover', function(event,d) {
        ...
        tooltip2.html(
          function(){
            if(d.SCRS == 0){return "<img src='img/stress5.png' style='width:460px'>"}
            else if((d.SCRS >= 1 && d.SCRS < 5)){return "<img src='img/stress4.png' style='width:460px'>"}
            else if(d.SCRS >= 5 && d.SCRS < 10){return "<img src='img/stress3.png' style='width:460px'>"}
            else if(d.SCRS >= 10 && d.SCRS <= 15){return "<img src='img/stress2.png' style='width:460px'>"}
            else {return "<img src='img/stress1.png' style='width:460px'>"}
          }
        );
      })
  ...
  function ticked() {
    ...
    //表情图片（用不上
    /*const emoj = boundscircle.selectAll(".emoj")
      .data(xiangqiecircle, function(d) { return d.id; });
